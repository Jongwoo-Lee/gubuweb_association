...
import { Box, makeStyles, Card, CardContent, Typography, ButtonBase, Grid } from "@material-ui/core";
import { RecordType } from "./RecordField";
import { CurTime, useSelUsr, makeQuarterString } from "../../../../context/cup/cupRecord";
...
export const AddScore: React.FC<AddScoreProps> = ({
    ...
    const notEnter = () =>
        (<div className={classes.row}>
            <div><img width="30" src={Trophy} /></div>
            <div>미입력</div>
        </div>);
    ...
    return <Card variant="outlined" className={classes.root}>
        ...
        <CardContent className={classes.col}>
            ...
            <ButtonBase> <Typography>취소</Typography></ButtonBase>
        </CardContent>
        <CardContent className={classes.row}>
            <Grid container direction="row" alignItems="center">
                <Grid item>
                    <Typography  >골:</Typography>
                </Grid>
